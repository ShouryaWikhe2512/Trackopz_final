    ...
    try {
      ...
      switch (selectedReportType) {
        ...
        case "Process Wise":
          if (!selectedProcess || !processStartDate || !processEndDate) {
            alert(
              "Please select process and date range for Process Wise report"
            );
            return;
          }
          break;
      ...
      switch (selectedReportType) {
        ...
        case "Monthly":
          ...
          break;
        case "Process Wise":
          downloadUrl += `&process=${encodeURIComponent(
            selectedProcess
          )}&startDate=${processStartDate}&endDate=${processEndDate}`;
          break;
      }
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              onClick={() => {
                ...
                const url = `/api/reports/process-wise-export?process=${encodeURIComponent(
                  selectedProcess
                )}&startDate=${processStartDate}&endDate=${processEndDate}`;
                window.location.href = url;
              }}
              disabled={
                !selectedProcess || !processStartDate || !processEndDate
              }
            >
