...
//         >
//           <span className="text-gray-700 truncate max-w-[calc(100%-30px)]">
//             {value}
//           </span>
//           <ChevronDown
...
//   const validateProductStatus = async (
//     productName: string,
//     machine: string,
//     state: string
//   ): Promise<boolean> => {
...
//     const isValid = await validateProductStatus(
//       selectedProduct,
//       selectedMachine,
//       selectedState
//     );
...
//       setMessage({
//         text: "Please enter a valid quantity (1-1000)",
//         type: "error",
//       });
//       return;
//     }
...
//         setValidationMessage("");
//         setMessage({
//           text: `Successfully added ${quantity} job(s)!`,
//           type: "success",
//         });
//       } else {
//         const errorData = await res.json();
//         setMessage({
//           text: `Failed to add job: ${errorData.error || "Unknown error"}`,
//           type: "error",
//         });
//       }
//     } catch {
...
//         <h1 className="text-lg md:text-xl font-semibold text-white text-center flex-grow">
//           Add Jobs
//         </h1>
...
//               disabled={
//                 isValidating ||
//                 (selectedState === "OFF" && validationMessage.startsWith("❌"))
//               }
...
export default function AddJobsForm() {
  ...
  const handleAddJob = async (): Promise<void> => {
    ...
    const isValid = await validateProductStatus(
      selectedProduct,
      `${selectedMachine} #${machineNumber.trim()}`,
      selectedState
    );
    if (!isValid) {
      return; // Don't proceed if validation fails
          ...
          <div className="mb-4 md:mb-6">
            ...
            <input
              ...
              className={`w-full bg-white border ${
                machineNumberError ? "border-red-500" : "border-gray-300"
              } rounded-lg px-4 py-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors`}
              value={machineNumber}
              onChange={(e) => {
                ...
                if (
                  ...
                  validateProductStatus(
                    selectedProduct,
                    `${selectedMachine} #${e.target.value.trim()}`,
                    selectedState
                  );
                }
              }}
